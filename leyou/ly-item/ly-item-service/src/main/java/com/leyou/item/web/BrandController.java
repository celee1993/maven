...
public class BrandController {
     ...
     */
    @GetMapping("/cid/{id}")
    public ResponseEntity<List<Brand>> findBrandsByCid(@PathVariable("id") Long id) {
        List<Brand> brands=brandService.findBrandsById(id);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Brand> findBrandsById(@PathVariable("id") Long id) {
